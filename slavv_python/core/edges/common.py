...
from slavv_python.core.energy.provenance import is_exact_compatible_energy_origin
from slavv_python.core.vertices.results import matlab_linear_indices as _matlab_linear_indices
...
def _build_matlab_global_watershed_lut_cached(
    ...
    *,
    ...
    return {
        ...
        "pointer_indices": pointer_indices,  # NEW
