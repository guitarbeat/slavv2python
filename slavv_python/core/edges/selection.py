...
from slavv_python.core.edges.finalize import prefilter_edge_indices_for_cleanup_matlab_style
from slavv_python.core.edges.payloads import _empty_edges_result
...
def _snapshot_endpoint_influences_matlab(
    ...
    if not endpoint_coord_groups:
        ...
        return (
            ...
            np.zeros((0,), dtype=painted_source_image.dtype),
        )
