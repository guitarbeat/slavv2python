...
if TYPE_CHECKING:
    ...
    from slavv_python.processing.stages.edges.common import Float32Array, Float64Array, Int16Array, Int32Array
    from slavv_python.processing.stages.edges.tracing import TraceMetadata
else:
...
from slavv_python.processing.stages.edges.radius_utils import _scalar_radius
...
def _edge_candidates_facade() -> Any:
    ...
    from slavv_python.processing.stages.edges import candidates as edge_candidates_facade
...
def _trace_fallback_origin_candidates(
    *,
    ...
    from slavv_python.processing.stages.edges.trace_metrics import (
...
def _generate_edge_candidates(
    ...
    from slavv_python.processing.stages.edges.payloads import _merge_edge_diagnostics
