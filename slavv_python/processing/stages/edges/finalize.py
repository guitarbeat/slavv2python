...
def prefilter_edge_indices_for_cleanup_matlab_style(
    ...
    *,
    ...
    from slavv_python.processing.stages.network import _matlab_smooth_edges_v2
...
def finalize_edges_matlab_style(
    ...
    *,
    ...
    from slavv_python.processing.stages.network import _matlab_edge_metrics, _matlab_smooth_edges_v2
