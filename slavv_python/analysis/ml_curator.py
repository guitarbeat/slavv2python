...
try:
    ...
    from slavv_python.analysis.automatic_curator import AutomaticCurator
    from slavv_python.analysis.curation_heuristics import (
        choose_edges,
        choose_vertices,
        extract_uncurated_info,
    )
    from slavv_python.analysis.drews_curator import DrewsCurator
