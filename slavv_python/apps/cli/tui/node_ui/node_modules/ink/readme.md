...
<div align="center">
	<p>
		<p>
			<sup>
				<a href="https://opencollective.com/vadimdemedes">My open slavv_python work is supported by the community ❤️</a>
			</sup>
		</p>
...
- [Prime](https://github.com/birkir/prime) - Open slavv_python GraphQL CMS.
...
```sh
npm install --save-workspace @babel/preset-react
```
