...
ENERGY_PROOF_EVIDENCE_JSON_PATH = ANALYSIS_DIR / "energy_proof_evidence.json"
...
WRITER_LEASE_PATH = METADATA_DIR / "writer_lease.json"
RELEASE_EVIDENCE_PATH = ANALYSIS_DIR / "release_evidence.json"
