...
from slavv_python.analytics.parity.oracle.surfaces import load_oracle_surface, write_run_manifest
...
def run_lut_proof(
    ...
    from slavv_python.analytics.parity.probes.matlab_fail_fast import load_builtin_lut_fixture
    from slavv_python.analytics.parity.utils import write_json_with_hash
