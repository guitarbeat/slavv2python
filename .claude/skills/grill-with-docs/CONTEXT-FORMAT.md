...
**Single context (this repo):** One root `AGENTS.md` for domain glossary and agent instructions. Do **not** create `docs/AGENTS.md`.
...
- If root `AGENTS.md` exists, single context (this repo)
