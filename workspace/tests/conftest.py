...
def pytest_collection_modifyitems(items):
    ...
    for item in items:
        ...
        if "workspace/tests/unit/" in nodeid:
            item.add_marker("unit")
        elif "workspace/tests/integration/" in nodeid:
            item.add_marker("integration")
        elif "workspace/tests/ui/" in nodeid:
            item.add_marker("ui")
        elif "workspace/tests/diagnostic/" in nodeid:
            item.add_marker("diagnostic")

        if "workspace/tests/benchmarks/" in nodeid:
