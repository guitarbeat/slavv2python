...
def test_extract_edges_direction_padding_is_repeatable(monkeypatch):
    ...
    monkeypatch.setattr(
        "slavv_python.core.edge_candidates.estimate_vessel_directions", fake_estimate
    )
    monkeypatch.setattr("slavv_python.core.edge_candidates.generate_edge_directions", fake_generate)
    monkeypatch.setattr("slavv_python.core.edge_candidates.trace_edge", fake_trace_edge)
