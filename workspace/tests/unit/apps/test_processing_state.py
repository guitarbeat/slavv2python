...
from workspace.tests.support.payload_builders import build_processing_results
...
def test_store_processing_session_state_persists_processing_outputs():
    ...
    processing_results = build_processing_results(overrides={"metadata": {"source": "processing"}})
    ...
    assert session_state["processing_results"]["metadata"] == {"source": "processing"}
