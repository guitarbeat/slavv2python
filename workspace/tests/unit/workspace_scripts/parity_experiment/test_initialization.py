...
def test_init_exact_run_bootstraps_source_surface_from_dataset_and_oracle(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("slavv_python.io.tiff.load_tiff_volume", _fake_load_tiff)
    monkeypatch.setattr("slavv_python.core.pipeline.SLAVVProcessor", FakeProcessor)
...
def test_init_exact_run_can_finalize_existing_completed_seed(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("slavv_python.io.tiff.load_tiff_volume", _fake_load_tiff)
    monkeypatch.setattr("slavv_python.core.pipeline.SLAVVProcessor", FirstProcessor)
    ...
    monkeypatch.setattr("slavv_python.core.pipeline.SLAVVProcessor", SecondProcessor)
    parity_experiment.main(
        [
            "init-exact-run",
            "--dataset-root",
