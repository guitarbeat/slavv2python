...
from source.apps.state.analysis import (
    normalize_analysis_results as canonical_normalize_analysis_results,
)
...
def test_grouped_app_import_surfaces_export_expected_symbols():
    ...
    assert generate_export_data is canonical_generate_export_data
    assert normalize_analysis_results is canonical_normalize_analysis_results
