...
def show_visualization_page():
    ...
    with col1:
        ...
        if viz_type == "2D Network":
            ...
            # Note: plot_energy_field is fast enough and depends on slice_index which changes often, so skipping cache for now
            # or could cache it if needed, but the slice index is granular.
