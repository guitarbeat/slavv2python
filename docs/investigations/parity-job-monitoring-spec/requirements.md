...
- [Exact Proof Findings](../../reference/core/EXACT_PROOF_FINDINGS.md) - Cold-start protocol section
- [Detached Exact-Run Jobs Solution](../../solutions/parity/detached-exact-run-jobs.md)
