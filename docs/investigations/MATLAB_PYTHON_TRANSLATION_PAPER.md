...
> **History / draft methodology — not live status.**
>
> **In short:** This draft still talks as if Network is open. That is **out of
> date.** Phase 1 is CLOSED (close enough to ship). Identical last digits is a
> separate leftover. Live pass/fail: [ONE TRUTH](../reference/core/EXACT_PROOF_FINDINGS.md#one-truth--phase-1-parity-validated-from-disk).
> Body below is a translation-method narrative; do not copy its status sentences.
