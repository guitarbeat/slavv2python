...
5. **[Phase 1 Spec](plans/phase-1-exact-route-spec.md)** — Certification requirements
6. **[MATLAB Parity Mapping](reference/core/MATLAB_PARITY_MAPPING.md)** — Function-to-function mappings
