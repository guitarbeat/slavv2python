...
### 🆕 New to SLAVV
1. **[New engineer start here](reference/core/NEW_ENGINEER_START_HERE.md)** — Two products (Paper Path vs Exact Route; “paper” also means Mihelic 2021), first-week reading paths, common traps
...
5. [Papers we actually use](reference/papers/README.md) — which citation (or “no paper”) answers which confusion
