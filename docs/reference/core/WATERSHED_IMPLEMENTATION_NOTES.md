...
The watershed discovery is implemented as a single-pass discovery over shared spatial maps. The implementation is located in `slavv_python/processing/stages/edges/global_watershed.py`.
