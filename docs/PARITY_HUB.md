...
This is the fastest re-entry point for MATLAB-vs-Python parity work.

If you only read one file before jumping back in, read this one.
...
| How do staged comparison run roots work? | [COMPARISON_LAYOUT.md](COMPARISON_LAYOUT.md) |
| Where is the MATLAB-to-Python module map? | [MATLAB_MAPPING.md](MATLAB_MAPPING.md) |
