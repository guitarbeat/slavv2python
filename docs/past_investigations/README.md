...
- [Translation Pair Analysis](translation_pair_analysis/README.md)
- [May 2026 Commit Messages](MAY_2026_COMMIT_MESSAGES.md)
...
Start from [CHAPTER_TEMPLATE.md](CHAPTER_TEMPLATE.md) if a new investigation genuinely needs a chapter.
