...
- `tests/unit/workspace_scripts/` for maintained helper scripts under `scripts/`
...
- Keep exact-route parity tests under the owning package surface, or under `tests/unit/workspace_scripts/` for maintained developer runners such as `scripts/cli/parity_experiment.py`.
