...
def run_candidate_capture(
    ...
    energy_payload = load_json_dict(
        source_surface.run_root / "02_Output" / "python_results" / "checkpoints" / "checkpoint_energy.json") or {}
    vertices_payload = load_json_dict(
        source_surface.run_root / "02_Output" / "python_results" / "checkpoints" / "checkpoint_vertices.json") or {}
